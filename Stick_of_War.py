...
class GameStickOfWar:
    ...
    def reset_func(self):
        ...
        self.warrior_button = TroopButton(self, self.warrior_button_image, self.warrior_button_dim_image, self.warrior_button_flash,
                                          self.warrior_lock,
                                          (100, 100), (100, 70), f'{database.warrior_gold}n{database.warrior_diamond}', 3000, database.warrior_gold, database.warrior_diamond)
        ...
        self.archer_button = TroopButton(self, self.archer_button_image, self.archer_button_dim_image, self.archer_button_flash,
                                         self.archer_lock,
                                         (100, 100), (200, 70), f'{database.archer_gold}n{database.archer_diamond}', 3000, database.archer_gold, database.archer_diamond)
